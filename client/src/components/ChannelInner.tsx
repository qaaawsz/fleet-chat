...
const ChannelInner: React.FC<IChannel> = ({setIsEditing}) => {
...
const TeamChannelHeader: React.FC<IChannel> = ({setIsEditing}) => {
                ...
                <div className="team-channel-header__name-wrapper">
                    {members.map(({user}, i) => (
                        <div key={i} className="team-channel-header__name-multi">
                            <Avatar image={user?.image} name={`${user?.fullName || user?.id || user?.name}`} size={32}/>
